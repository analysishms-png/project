                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="file" name="dealer_logo_property" accept=".jpg,.png,.jpeg,.webp"
                                                id="dealer_logo_property" value="{{ $companydata->dealer_logo }}" class="form-control">
                                            <span id="dealer_logo_property_error" class="text-danger"></span>
                                        </div>

                                        <div class="col-md-4">
                                            <label class="col-lg-4 col-form-label" for="cover_image">Background Image <span
                                                    class="text-danger">*</span></label>
                                            <input type="file" name="cover_image" accept=".jpg,.png,.jpeg,.webp"
                                                id="cover_image" value="{{ $companydata->cover_image }}" class="form-control">
                                            <span id="cover_image_error" class="text-danger"></span>
                                        </div>

                                        <div class="col-md-4">
                                            <label class="col-lg-4 col-form-label" for="payment_qr_code">Payment QR Code <span
                                                    class="text-danger">*</span></label>
                                            <input type="file" name="payment_qr_code" accept=".jpg,.png,.jpeg,.webp"
                                                id="payment_qr_code" value="{{ $companydata->payment_qr_code }}" class="form-control">
                                            <span id="payment_qr_code_error" class="text-danger"></span>
                                        </div>
