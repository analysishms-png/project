                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <form class="form" method="POST" action="javascript:void(0)" autocomplete="off"
                                name="empcategorysubmitform" id="empcategorysubmitform" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label class="col-form-label" for="upname">Employee Category
                                                Name</label>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="updateModalLabel">Update Employee Category</h5>
        ...
        <script>
            ...
            $(document).ready(function () {
                ...
                var table = $('#empcategorymast').DataTable({
                    ...
                    ordering: true,
                    ajax: {
                        url: '{{ route('employeecategorydata') }}',
                        type: 'GET',
                        error: function (xhr) {
                    ...
                    buttons: [
                        {
                            ...
                            action: function (e, dt, button, config) {
                                ...
                                window.location.href = '/employeeexport';
                            }
                        },
                        {
                            extend: 'print',
                ...
                $('#empcategorysubmitform').on('submit', function (e) {
                    e.preventDefault();

                    $('span.error-text').text('');

                    $.ajax({
                        url: "{{ route('addemployeecategory') }}",   // 
                        method: "POST",
                ...
                $('#hrPayrollForm').on('submit', function (e) {
                    ...
                    $.ajax({
                        url: "{{ route('editemployeecategory') }}", // Laravel route for update
                        method: "POST",
                        data: new FormData(this),
                        processData: false,
                        contentType: false,
                ...
                $(document).on('click', '.deleteBtn', function () {
                    ...
                    if (confirm('Are you sure you want to delete this empcategory?')) {
                        $.ajax({
                            url: "{{ route('deleteemployeecategory') }}", // Laravel route
                            type: 'POST',
                            data: {
                                'sn': id,
