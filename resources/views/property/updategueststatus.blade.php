        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <form class="form" name="gueststatusformupdate" id="gueststatusformupdate"
                                action="{{ route('gueststatusstoreupdate') }}" method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
                                        <label class="col-form-label" for="name">Guest Status Name</label>
                                    ...
                                    <input type="hidden" value="{{ $data->gcode }}" name="gcode" id="gcode"
                                        class="form-control" required>
