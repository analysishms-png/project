                        ...
                        <div class="card-body">
                            ...
                            <form action="" method="post">
                                ...
                                <div class="text-center titlep">
                                    ...
                                    <p style="margin-top:-10px; font-size:16px;">Assignment Report</p>
                            ...
                            <div class="custom-header">Assignment Report</div>
                            <div class="mt-3" id="assignment-table"></div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $(document).on('click', '#refreshbutton', function () {
                ...
                if (!fromdate) {
                    pushNotify('error', 'Assignment Report', 'Please select From Date',
                        'fade', 300, '', '', true, true, true, 2000, 20, 20, 'outline', 'right top');
                    $('#fromdate').addClass('invalid');
                    return;
                }
                if (!todate) {
                    pushNotify('error', 'Assignment Report', 'Please select To Date',
                        'fade', 300, '', '', true, true, true, 2000, 20, 20, 'outline', 'right top');
                ...
                fdata.open('POST', '/assignmentreportfetch', true);
                            ...
                            let columns = [
                                ...
                                },
                                {
                                    ...
                                    formatter: function (cell) {
                                        ...
                                        return `<span style="color:#198754;font-weight:600;">${val}</span>`;
                                    },
                                },
                                {
                                    title: "In Progress",
                                    ...
                                    formatter: function (cell) {
                                        let val = cell.getValue();
                                        return `<span style="color:#fd7e14;font-weight:600;">${val}</span>`;
                                    },
                                },
                                {
                                    title: "Pending",
                                ...
                                {
                                    title: "Avg Est. Time (min)",
                                    field: "avgest",
                                    sorter: "number",
                                    hozAlign: "right",
                                },
                                {
                                    title: "Avg Actual Time (min)",
                                    field: "avgactual",
                                    sorter: "number",
                                    hozAlign: "right",
                                },
            ...
            $("#download-xlsx").on("click", function () {
                ...
                table.download("xlsx", `assignment_report_${fromdate}_to_${todate}.xlsx`, {
                    sheetName: "Assignment Report"
                });
            });
        });
        ...
        function processData(results) {
            ...
            results.forEach(function (row) {
                reportData.push({
                    ...
                    completed   : row.CompletedRooms   ?? 0,
                    inprogress  : row.InProgressRooms  ?? 0,
                    pending     : row.PendingRooms      ?? 0,
                    avgest      : row.AvgEst    ?? 0,
                    avgactual   : row.AvgActual ?? 0,
                });
            });
            return reportData;
        }
