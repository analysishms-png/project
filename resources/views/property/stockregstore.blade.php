...
<div class="container-fluid" style="margin-top:90px;">
   <div class="card"><div class="card-header d-flex justify-content-between align-items-center"><h5 class="mb-0"><i class="fas fa-file-alt"></i> stockregstore</h5><span class="badge badge-info">HMS.text</span></div>
      <div class="card-body">
         <div class="row mb-3">
...
<script>
$(function(){$('#fetchBtn').click(function(){$.post('{{ route("stockregstorefetch") }}',{fromdate:$('#fromdate').val(),todate:$('#todate').val(),_token:'{{ csrf_token() }}'},function(res){var html='';$.each(res.data||[],function(i,r){var keys=Object.keys(r);html+='<tr>';for(var k of keys)html+='<td>'+r[k]+'</td>';html+='</tr>';});$('#dataBody').html(html);});});
});
</script>
@endsection
