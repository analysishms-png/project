...
@section('main-container')
    ...
    <script>
        $(document).ready(function () {
            ...
            var table = $('#itemwisesalereport').DataTable({
                processing: true,
                serverSide: true,
                searching: true,
                paging: true,
                ordering: true,
                ajax: {
                    url: '{{ route('itemwisesalesreportdata') }}',
                    type: 'POST',
                    data: function (d) {
                ...
                columns: [
                    ...
                    //{ data: 'sdate', name: 'sdate' },   // Date
                    { data: 'item', name: 'item' },     // Item Name
                    { data: 'qty', name: 'qty' },       // Quantity
                    { data: 'unit', name: 'unit' },     // Unit
                    { data: 'rate', name: 'rate' },     // Rate
