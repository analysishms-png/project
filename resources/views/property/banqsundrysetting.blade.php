...
@section('main-container')
        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    <div class="card ">
                        <div class="card-body">
                            <form action="{{ route('banqsundrysetstore') }}" name="banqsundrysettingform" id="banqsundrysettingform" method="post">
                                @csrf
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($data as $row)
                                            <tr>
                                                ...
                                                <td>
                                                    <a
                                                        href="updatebanquetsundrysetting?sn={{ base64_encode($row->sn) }}&vtype={{ base64_encode($row->vtype) }}">
                                                        <button class="btn
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#banqsundrysettingform').on('submit', function(e) {
                e.preventDefault();
