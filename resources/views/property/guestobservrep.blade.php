...
<div class="container-fluid" style="margin-top:90px;">
   <div class="card">
      <div class="card-header d-flex justify-content-between align-items-center">
         <h4 class="card-title mb-0"><i class="fas fa-eye"></i> Guest Observation Report</h4>
      ...
      <div class="card-body">
         ...
         <table class="table table-sm table-bordered table-striped" id="rTable">
            <thead class="thead-dark"><tr><th class="">Room</th>
               ...
               <th class="">Observation/Remark</th>
               <th class="">Flag</th>
               </tr></thead>
...
$(document).ready(function() {
   ...
   $('#fetchBtn').click(function() {
      $.post('{{ route("guestobservrepfetch") }}', {fromdate:$('#fromdate').val(),todate:$('#todate').val()
...
var h='';var tot=0;$.each(res.data,function(i,r){
            ...
            h+='<tr>'+'<td class="">'+'<b>'+(r.roomno||'')+'</b>'+'</td>'+'<td class="">'+(r.name||'')+'</td>'+'<td class="">'+(r.mobile_no||'')+'</td>'+'<td class="">'+fmtDate(r.chkindate)+'</td>'+'<td class="">'+fmtDate(r.depdate)+'</td>'+'<td class="text-right">'+fmt(r.roomrate)+'</td>'+'<td class="">'+(r.reasonrchange||'')+'</td>'+'<td class="">'+(r.guest_status||'')+'</td>'+'</tr>';});
         $('#tableBody').html(h);
