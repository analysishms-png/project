...
<div class="content-body">
    <div class="container-fluid" style="margin-top:90px;">
        <div class="dash-title-bar">
            <div class="title-left"><h3>${report}</h3></div>
...
<script>
$(document).ready(function(){$('#fetchBtn').click(function(){$.post('{{ route("${report}fetch") }}',{fromdate:$('#fromdate').val(),todate:$('#todate').val()},function(res){var h='';$.each(res,function(i,r){h+='<tr><td>'+(i+1)+'</td><td>'+JSON.stringify(r)+'</td></tr>';});$('#tableBody').html(h);});});$('#fetchBtn').click();});
</script>
@endsection
