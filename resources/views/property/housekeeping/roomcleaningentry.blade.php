...
function rceFtrLoad() {
    ...
    .then(function (d) {
        ...
        d.data.forEach(function (row) {
            var stBg = row.cleaningstatus === 'Completed' ? '#198754' : (row.cleaningstatus === 'In Progress' ? '#0d6efd' : '#6c757d');
            var stBadge = '<span class="badge" style="background:' + stBg + ';">' + row.cleaningstatus + '</span>';
