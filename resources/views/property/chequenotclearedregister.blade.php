...
@section('main-container')
    ...
    <style>
        ...
        .tabulator .tabulator-row:hover { background: #ffe8e8 !important; }
                    ...
                    <div class="card shadow-sm">
                        <div class="card-body">
                            ...
                            <div class="text-center titlep mb-3">
                                ...
                                <p class="mb-0 font-weight-bold" style="color: #c0392b;">Cheque Not Cleared Register</p>
                            </div>
                            ...
                            <div class="row justify-content-center align-items-end mb-3">
                                ...
                                <div class="col-auto">
                                    ...
                                    <select id="bankselect" class="form-control form-control-sm" style="min-width:250px;">
                                ...
                                <div class="col-auto pt-2">
                                    <button type="button" id="refreshbutton" class="btn btn-danger btn-sm mt-3">
                                        <i class="fa fa-sync-alt"></i> Show Pending Cheques
                                    </button>
                            ...
                            {{-- Table --}}
                            <div class="mt-2">
                                <div class="custom-header" id="tableHeader">Cheque Not Cleared Register - Pending Cheques</div>
                                <div id="chqTable"></div>
                            </div>
    ...
    $(document).ready(function () {
        ...
        $('#refreshbutton').click(function () {
            ...
            $.ajax({
                url: "{{ route('fetchchequenotcleareddata') }}",
                method: 'POST',
                data: {
                    _token: '{{ csrf_token() }}',
                    fromdate,
                ...
                success: function (response) {
                    ...
                    if (!response || response.length === 0) {
                        $('#chqTable').html('<div class="alert alert-success mt-2">Great! All cheques are cleared. No pending cheques found.</div>');
                        return;
                    }
                    ...
                    $('#tableHeader').text('Cheque Not Cleared Register - Pending Cheques | ' + bankName);

                    table = new Tabulator('#chqTable', {
                        data: response,
                        layout: 'fitColumns',
                        height: 'auto',
                        placeholder: 'No Pending Cheques',
                        columns: [
                            { 
                                title: 'Cheque No.',  
                                field: 'chqno',      
                ...
                error: function (xhr, status, error) {
                    ...
                    $('#chqTable').html('<div class="alert alert-danger mt-2">Error fetching data: ' + error + '. Please try again.</div>');
                }
            });
        });
            ...
            let printHTML = `
                <div class="print-header-section">
                    ...
                    <div class="print-company-details">
                        ...
                        <p><strong>Cheque Not Cleared Register</strong></p>
                    </div>
                ...
                <div class="print-table-title">
                    Cheque Not Cleared Register | ${bankName} | ${fd} to ${td}
                </div>
                ...
                <table class="print-data-table">
                    <thead>
                        <tr>
                            ...
                            <th style="width:10%;">Cheque Dt.</th>
        ...
        $('#excelButton').click(function () {
            if (table) table.download('xlsx', 'ChequeNotClearedRegister.xlsx');
        });
    });
    </script>
@endsection
