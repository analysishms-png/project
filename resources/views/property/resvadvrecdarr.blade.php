...
<div class="container-fluid" style="margin-top:90px;">
   <div class="card">
      <div class="card-header d-flex justify-content-between align-items-center">
         <h4 class="card-title mb-0"><i class="fas fa-plane-arrival"></i> Advance Received - Arrivals</h4>
...
$(document).ready(function() {
   ...
   $('#fetchBtn').click(function() {
      $.post('{{ route("resvadvrecdarrfetch") }}', {fromdate:$('#fromdate').val(),todate:$('#todate').val()
