@include('property.salebillprint2ctype2ss')
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="receipt">
        ...
        <header>
            <div class="header-branding">
                ...
                <img src="" id="logo" name="logo" alt="Hotel Logo">
            </div>
        ...
        setTimeout(() => {
            ...
            outletxhr.onreadystatechange = function() {
                if (outletxhr.readyState === 4 && outletxhr.status === 200) {
                    ...
                    // console.log(r.outlet_title);
                    // console.log(r.company_title);
                    if (r.outlet_title == 'Y') {
                ...
                if (itemsxhr.readyState === 4 && itemsxhr.status === 200) {
                    ...
                    items.forEach((data) => {
                        if (parseFloat(data.amt) > 0) {
                            rows += `<tr>
                            <td>${data.itemname} ${data.discper > 0 ? `(${data.discper}%)` : ''}</td>
