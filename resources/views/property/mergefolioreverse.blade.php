                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="text-center">
                                <h3>List of Folio</h3>
                                <span class="text-danger font-weight-bold h4">Run Reverse Merge Folio Only at the time of checkout</span>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="text-center mt-4">
                                                <button id="mergebtn" class="btn btn-success" disabled>Reverse Merge Folio</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (bookedroomdata.length == 0) {
                        trdata += `<tr>
                                <td class="bg-danger text-white h5" colspan="6">No Data Found</td>
                            </tr>`;
                        tbody.append(trdata);
                        return;
                    }
