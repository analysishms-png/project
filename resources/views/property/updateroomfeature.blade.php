...
@section('main-container')
    <div class="content-body">
        ...
        <div class="container-fluid">
            @include('property.layouts.pageheader', ['hmsTitle' => 'Edit Room Features', 'hmsSubtitle' => 'Update room feature details and save'])

            <div class="row justify-content-center">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <form class="form" name="roomfeatureformupdate" id="roomfeatureformupdate"
                                action="{{ route('roomfeaturetoreupdate') }}" method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    <input type="hidden" value="{{ $data->rcode }}" name="rcode" id="rcode"
                                        class="form-control" required>
                                    <div class="col-md-6">
