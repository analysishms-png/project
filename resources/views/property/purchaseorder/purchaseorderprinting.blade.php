...
<div class="header">
    ...
    <div class="report-title">Purchase Order Entry</div>
</div>
...
@if(!is_null($data))
    ...
    <div class="doc-info">
        ...
        <div class="info-row">
            <div><strong>Memo/Inv. No. : </strong> {{ $first->quotno }}</div>
            <div><strong>Invoice Date : </strong> {{ \Carbon\Carbon::parse($first->quotdate)->format('d/m/y') }}</div>
        </div>
    </div>
    <div class="doc-info">
        <div class="info-row">
            <div><strong>Disp.Mode : </strong>{{ $first->dispatchmode }} </div>
            <div><strong>Fwd.Charge : </strong>{{ $first->forwardcharges }} </div>
        </div>
        <div class="info-row">
            <div><strong>Pack.Charge : </strong>{{ $first->packcharge }} </div>
            <div><strong>Discount : </strong>{{ $first->discper }}</div>
        </div>
        <div class="info-row">
            <div><strong>Sur.Charge : </strong>{{ $first->surcharge }} </div>
            <div><strong>Desp.Thru : </strong>{{ $first->despatchthru }} </div>
        </div>
        <div class="info-row">
            <div><strong>Pay.Terms : </strong>{{ $first->paymentterms }} </div>
        </div>
    </div>
    <table>
        <thead>
