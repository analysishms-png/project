...
<head>
    ...
    <title>Requisition Slip - Print</title>
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        /* CHANGE 1: Item Name column - chota kiya */
        ...
        /* CHANGE 2: Quantity column - width fix ki */
...
<body>
        ...
        <table class="header-table">
            <tr>
                ...
                <td class="header-title-cell">
                    ...
                    <p><strong>REQUISITION SLIP</strong></p>
                </td>
            </tr>
        </table>
    </div>
        ...
        <table class="items-table">
            ...
            <tbody>
                ...
                <tr>
                    <td>{{ $row->sno }}</td>
                    <td>{{ $row->Name }}</td>
                    <td style="text-align: right;">{{ number_format($row->stock ?? 0, 2) }}</td>
    ...
    @else
        <div style="text-align: center; margin-top: 50px;">
            <h3>No Data Found</h3>
            <p>Requisition slip data not available.</p>
        </div>
    @endif
