...
class DayBookExport
{
    ...
    public function __construct($fromdate, $todate, $propertyid, $companyName, $vtype = '')
    {
    ...
    public function download()
    {
        ...
        $sheet->setCellValue('A2', 'Day Book (' . date('d-m-Y', strtotime($this->fromdate)) . ' To ' . date('d-m-Y', strtotime($this->todate)) . ')' . ($this->vtype ? ' — Vch Type: ' . $this->vtype : ''));
        ...
        $fileName = 'day-book-' . date('Ymd-His') . '.xlsx';
