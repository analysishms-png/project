...
class ItemCategoryExport
{
    ...
    public function download()
    {
        ...
        $sheet->setCellValue('A2', 'Item Category');
        ...
        $currentRow = 4;
        $headers    = ['Sn.', 'Name', 'Department', 'Tax Structure', 'Account Name'];
        $cols       = ['A', 'B', 'C', 'D', 'E'];
        ...
        header('Content-Disposition: attachment; filename="Item_Category.xlsx"');
