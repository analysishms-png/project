        ...
        <div class="row page-titles mx-0">
            <div class="col p-md-0">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">New Page</a></li>
                </ol>
            </div>
        </div>
                ...
                <div class="card-body">
                    <form action="{{ route('superadmin.pages.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" id="description" class="form-control" placeholder="Enter page description or content">{{ old('description') }}</textarea>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Auto-generate on page load if name exists
        if (nameInput.value) {
