    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '#refreshbutton', function() {
                ...
                fdata.open('POST', '/voidbillsfetch', true);
                ...
                fdata.send(`fromdate=${fromdate}&todate=${todate}& _token={{ csrf_token() }}`);
            });
            ...
            //     let header = < h3 > $ {
            //         $('.titlep').html()
            //     } < /h3><p>From Date: ${fromdateText} To Date: ${todateText}</p > ;
