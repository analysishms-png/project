        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <form class="form" name="stateregform" id="stateregform" action="{{ route('statestore2') }}"
                                method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col">
                            ...
                            <tbody>
                                ...
                                @foreach ($state_data as $state)
                                    <tr>
                                        ...
                                        <td>{{ $state->u_name }}</td>
                                        <td class="ins"> <a
                                                href="updatestateform?state_code={{ base64_encode($state->state_code) }}">
                                                <button class="btn btn-success btn-sm"><i
                                                        class="fa-regular fa-pen-to-square"></i>Edit</button></a>
                                            <a href="deletestate?state_code={{ base64_encode($state->state_code) }}">
