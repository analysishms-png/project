...
@section('main-container')
    ...
    <script>
        $(document).ready(function() {
            ...
            function updatePrintHeaderDates(fromdate, todate) {
                ...
                if (fromdate != '' && todate != '') {
                    ...
                    fdata.onreadystatechange = function() {
                        if (fdata.status === 200 && fdata.readyState === 4) {
                            ...
                            updatePrintHeaderDates(fromdate, todate);

                            if (table) {
                                table.options.printHeader = getPrintHeaderHtml();
                                ...
                                table = new Tabulator("#settlement-summary", {
                                    ...
                                    layout: "fitColumns",
                                    groupBy: "outletName",
                                    printHeader: getPrintHeaderHtml(),
            ...
            function processData(results) {
                ...
                results.report.forEach(sale => {
                    let description = `${sale.comments} / ${sale.rooomnoset}`;
                    
                    /* Add company name if it exists */
                    if (sale.paycompanyname && sale.comments.includes('Company')) {
                        description = `${sale.comments} ${sale.paycompanyname} / ${sale.rooomnoset}`;
                    }
