                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="d-flex gap-2 px-1 pb-2 pt-1">
                            <button type="button" onclick="window.location.href='{{ route('events.export') }}'" class="btn btn-success btn-sm">Excel</button>
                            <button type="button" onclick="window.open('{{ route('printevents') }}','_blank')" class="btn btn-info btn-sm text-white">Print</button>
                        </div>
