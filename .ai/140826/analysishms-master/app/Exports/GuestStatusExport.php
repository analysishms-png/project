...
class GuestStatusExport
{
    ...
    public function download()
    {
        ...
        $sheet->setCellValue('A2', 'Guest Status');
        ...
        $currentRow = 4;
        foreach (['Sn.', 'Name', 'Defined'] as $i => $h) {
        ...
        header('Content-Disposition: attachment; filename="Guest_Status.xlsx"');
